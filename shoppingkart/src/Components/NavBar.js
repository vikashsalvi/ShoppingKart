...
class Navigation extends Component {
     ...
     async validate(e) {
         if ((e.type === "keydown" && e.keyCode === 13) || e.type === "click") {
             ...
             if (val === "") {
                 ...
                 const data = await Axios.get("https://csci-5709-web-24.herokuapp.com/product/getSearchedProduct/" + val);
    ...
    async showList(e) {
        ...
        if (userInp.length > 0) {
            const data = await Axios.get("https://csci-5709-web-24.herokuapp.com/product/getSuggestion/" + userInp);
